        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/services/roof-insulation-shinko" className="text-gray-400 hover:text-brand-orange-500 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-white/20"></div>عزل شينكو بالرياض</Link></li>
              ...
              <li><Link href="/services/roof-insulation" className="text-gray-400 hover:text-brand-orange-500 transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-white/20"></div>عزل أسطح بالرياض</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/privacy-policy" className="text-gray-400 hover:text-white transition-colors">سياسة الخصوصية</Link></li>
