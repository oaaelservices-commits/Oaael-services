...
export const metadata: Metadata = {
  ...
  title: {
    default: "شركة عزل أسطح بالرياض | عزل فوم حراري مائي | ضمان 10 سنوات | 0551777962",
    template: '%s | شركة عزل أسطح بالرياض | 0551777962'
  },
  description: "شركة عزل فوم بالرياض ✅ خبرة 15 سنة في عزل الفوم والعزل الحراري والمائي ✅ ضمان 10 سنوات ✅ أسعار تنافسية ✅ فريق محترف ✅ كشف تسربات المياه ✅ عزل خزانات. نخدم جميع أحياء الرياض: الملقا، الياسمين، النرجس، العليا، الروضة. اتصل الآن: 0551777962",
  keywords: [
    ...
    "عزل فوم بالخرج", "عزل اسطح بالخرج", "كشف تسربات المياه بالرياض",
