...
export const metadata: Metadata = {
    title: 'شركة عزل أسطح بالرياض | 0551777962 | ضمان 15 سنة| شركة اوائل العزل',
                ...
                testimonials={[
                    {
                        ...
                        text: 'كانت حرارة الدور الثاني لا تطاق في الظهر. ركبنا عزل فوم من اوائل العزل والفرق صراحة خيالي. المكيف صار يبرد ويفصل، والشغل كان نظيف جداً.',
                        rating: 5,
                    },
                    {
                        name: 'أم عبد الرحمن',
