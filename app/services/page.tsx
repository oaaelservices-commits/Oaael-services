...
export const metadata: Metadata = {
  title: 'خدمات العزل بالرياض | عزل فوم - حراري - مائي - خزانات',
...
const services = [
  ...
  },
  {
    ...
    longDescription: 'نستخدم أحدث أجهزة الكشف الإلكتروني لتحديد مواقع تسربات المياه بدقة متناهية دون الحاجة للتكسير. فريقنا المتخصص يقدم تقرير فني مفصل يوضح أماكن التسرب وأسبابه والحلول المقترحة.',
    icon: Search,
  ...
  },
  {
    ...
    description: 'عزل خزانات المياه بمادة الإيبوكسي المعتمدة من هيئة الغذاء والدواء. نضمن نقاء الماء وحماية الخزان من التآكل.',
    longDescription: 'نقدم خدمة عزل خزانات المياه باستخدام مادة الإيبوكسي الغذائي المعتمد من SFDA. العزل يحمي الخزان من التآكل والصدأ ويضمن نقاء المياه وسلامتها. نقوم بتنظيف الخزان وتعقيمه قبل تطبيق العزل.',
    icon: Container,
    color: 'text-cyan-500',
    bgColor: 'bg-cyan-50',
