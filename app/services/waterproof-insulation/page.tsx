      ...
      ======================================== */}
            <section className="relative bg-gradient-to-br from-navy-500 via-navy-600 to-navy-700 text-white py-24 overflow-hidden">
                <div className="absolute inset-0 opacity-20">
                    ...
                    <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-orange-500 rounded-full filter blur-3xl"></div>
                </div>
            ...
            <RelatedServices
                ...
                services={[
                    ...
                    { title: 'كشف تسربات المياه', description: 'كشف بدون تكسير بأجهزة إلكترونية', href: '/services/leak-detection', icon: <Droplets className="w-6 h-6" /> },
